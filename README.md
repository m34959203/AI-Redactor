...
**🆕 v3.0: Gemini 1.5 Flash — единый AI провайдер!**
- ⚡ **Google Gemini 1.5 Flash** — стабильная версия с хорошим free tier
...
- **Google Gemini 1.5 Flash** - единый AI провайдер

### AI Архитектура
```
┌─────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│   Frontend      │────▶│   Backend API   │────▶│  Gemini 1.5     │
│   (React)       │     │   (Express)     │     │     Flash       │
└─────────────────┘     └─────────────────┘     └─────────────────┘
                                                        │
                              ┌──────────────────────────┼──────────────────────────┐
...
- [Google AI](https://ai.google.dev/) за Gemini 1.5 Flash с отличной мультиязычной поддержкой
