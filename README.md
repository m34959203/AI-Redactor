...
**🆕 v2.0: Groq + пакетная обработка = 20x ускорение!**
- ⚡ **Groq API** (primary) - 30 req/min, llama-3.3-70b
- 🔄 **OpenRouter** (fallback) - автоматическое переключение при ошибках
- 📦 **Batch processing** - 5 статей за 1 запрос
...
|---------|---------|------------|-----------|
| Запросов на статью | 4 | 0.2 | **20x** |
| Время на 30 статей | ~4 мин | ~30 сек | **8x** |
| Rate limit | 20 req/min | 30 req/min | **1.5x** |

**Оптимизации:**
- Пакетная обработка: 5 статей за 1 API запрос
