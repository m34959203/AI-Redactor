...
Проект развёрнут в production-окружении по адресу:

**🌐 [https://airesume.zhezu.kz](https://airesume.zhezu.kz)**

- **Организация:** Жезказганский университет имени О.А. Байконурова
- **Домен:** субдомен университетского сайта [zhezu.kz](https://zhezu.kz)

Приложение используется для автоматизации сборки научного журнала «Вестник ЖезУ».
...
**Текущий production:** [https://airesume.zhezu.kz](https://airesume.zhezu.kz) — субдомен Жезказганского университета им. О.А. Байконурова
